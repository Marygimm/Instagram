...
struct RegistrationViewModel: AuthenticationViewModel {
    ...
    var buttonBackgroundColor: UIColor {
        return formIsValid ? UIColor.blue : UIColor.systemPurple.withAlphaComponent(0.5)
    }
...
struct ResetPasswordViewModel: AuthenticationViewModel {
    ...
    var buttonBackgroundColor: UIColor { return formIsValid ? UIColor.blue : UIColor.systemPurple.withAlphaComponent(0.5) }
